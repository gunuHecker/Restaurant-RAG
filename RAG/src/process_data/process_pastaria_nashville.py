...
RAW_DIR = os.path.join(PROJECT_ROOT, 'data', 'raw', 'pastaria_nashville', 'json')
PROCESSED_DIR = os.path.join(PROJECT_ROOT, 'data', 'processed', 'json')
OUTPUT_PATH = os.path.join(PROCESSED_DIR, 'PastariaNashville.json')
...
def main():
    ...
    print(f"PastariaNashville.json written to {OUTPUT_PATH}")
